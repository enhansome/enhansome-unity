...
* [San Andreas Unity](https://github.com/GTA-ASM/SanAndreasUnity) ⭐ 2,626 | 🐛 40 | 🌐 C# | 📅 2023-06-16 - An open source reimplementation of GTA San Andreas game engine in Unity.
...
* [Darkest Dungeon](https://github.com/Reinisch/Darkest-Dungeon-Unity) ⭐ 1,380 | 🐛 4 | 🌐 C# | 📅 2021-10-09 - Darkest Dungeon port in Unity. Almost completely identical to the original.
...
* [Multiplayer-FPS](https://github.com/Armour/Multiplayer-FPS) ⭐ 1,249 | 🐛 18 | 🌐 C# | 📅 2024-12-30 - A multiplayer first-person shooter game based on Unity3D. Different types of input devices are supported, including Kinect, Xbox controllers, Leap motion, and VR Glasses.
...
* [OpenVR XR](https://github.com/ValveSoftware/unity-xr-plugin) ⭐ 335 | 🐛 72 | 🌐 C# | 📅 2025-10-29 - OpenVR plugin for Unity's XR API.
...
* [Runtime Unity Editor/Debugging Tools](https://github.com/ManlyMarco/RuntimeUnityEditor) ⭐ 1,116 | 🐛 9 | 🌐 C# | 📅 2026-09-04 - In-game inspector and debugging tools for applications made with Unity3D game engine.
...
* [Native Toolkit](https://github.com/ryanw3bb/unity-native-toolkit) ⭐ 276 | 🐛 18 | 🌐 Java | 📅 2026-03-24 - Easily integrate native iOS & Android functionality into Unity projects.

## Utilities

* [Yarn Spinner](https://github.com/YarnSpinnerTool/YarnSpinner) ⭐ 2,840 | 🐛 3 | 🌐 C# | 📅 2026-09-16 - A tool for building interactive dialogue in games!
...
* [Unity2D Components](https://github.com/cmilr/Unity2D-Components) ⭐ 819 | 🐛 1 | 🌐 C# | 📅 2021-01-23 - A varied collection of Unity3D components that I've built for use in the 2D Platformer/RPG I'm currently developing.
...
* [GameDev-Resources](https://github.com/Kavex/GameDev-Resources) ⭐ 6,985 | 🐛 17 | 📅 2026-04-10 - A wonderful list of Game Development resources.
* [Awesome Unity Open Source on GitHub (800+)](https://github.com/baba-s/awesome-unity-open-source-on-github) ⭐ 4,476 | 🐛 14 | 📅 2026-02-02 - A categorized collection of awesome Unity open source on GitHub.

...
* [San Andreas Unity](https://github.com/GTA-ASM/SanAndreasUnity) ⭐ 2,601 | 🐛 39 | 🌐 C# | 📅 2023-06-16 - An open source reimplementation of GTA San Andreas game engine in Unity.
...
* [Nodulus](https://github.com/Hyperparticle/nodulus) ⭐ 622 | 🐛 4 | 🌐 C# | 📅 2023-03-30 - A puzzle game with a clever twist. Based on the mathematical theory behind plank puzzles, consists of a grid of cubes and rods which can be rotated with a swipe.
...
* [Darkest Dungeon](https://github.com/Reinisch/Darkest-Dungeon-Unity) ⭐ 1,365 | 🐛 4 | 🌐 C# | 📅 2021-10-09 - Darkest Dungeon port in Unity. Almost completely identical to the original.
...
* [Multiplayer-FPS](https://github.com/Armour/Multiplayer-FPS) ⭐ 1,242 | 🐛 18 | 🌐 C# | 📅 2024-12-30 - A multiplayer first-person shooter game based on Unity3D. Different types of input devices are supported, including Kinect, Xbox controllers, Leap motion, and VR Glasses.

## Strategy

* [Starcraft Unity3D](https://github.com/coconauts/startcraft-unity3d) ⭐ 703 | 🐛 3 | 🌐 C# | 📅 2025-09-12 - A recreation of the classic Starcraft game by Blizzard, on Unity3D.
...
* [XR-Interaction-Toolkit-Examples](https://github.com/Unity-Technologies/XR-Interaction-Toolkit-Examples) ⭐ 1,304 | 🐛 89 | 🌐 C# | 📅 2026-02-14 - Various examples to use with the XR Interaction Toolkit.
...
* [Path-Creator](https://github.com/SebLague/Path-Creator) ⭐ 2,082 | 🐛 89 | 🌐 C# | 📅 2024-05-02 - An intuitive and lightweight editor for quickly creating smooth paths in the editor.
* [Runtime Unity Editor/Debugging Tools](https://github.com/ManlyMarco/RuntimeUnityEditor) ⭐ 1,103 | 🐛 9 | 🌐 C# | 📅 2026-08-04 - In-game inspector and debugging tools for applications made with Unity3D game engine.
...
* [Native Toolkit](https://github.com/ryanw3bb/unity-native-toolkit) ⭐ 277 | 🐛 18 | 🌐 Java | 📅 2026-03-24 - Easily integrate native iOS & Android functionality into Unity projects.

## Utilities

* [Yarn Spinner](https://github.com/YarnSpinnerTool/YarnSpinner) ⭐ 2,822 | 🐛 3 | 🌐 C# | 📅 2026-08-11 - A tool for building interactive dialogue in games!
...
* [Unity2D Components](https://github.com/cmilr/Unity2D-Components) ⭐ 818 | 🐛 1 | 🌐 C# | 📅 2021-01-23 - A varied collection of Unity3D components that I've built for use in the 2D Platformer/RPG I'm currently developing.
...
* [Design Patterns Written in Unity3D](https://github.com/QianMo/Unity-Design-Pattern) ⭐ 4,672 | 🐛 5 | 🌐 C# | 📅 2020-02-06 - All Gang of Four Design Patterns written in Unity C# with many examples.
...
* [SOLID](https://github.com/ugonnathelma/articles/blob/master/the-solid-principles-in-pictures/the-solid-principles-in-pictures.md) ⭐ 27 | 🐛 0 | 📅 2020-07-14 - The S.O.L.I.D Principles in Pictures.
* [.Net Documentation](https://github.com/proyecto26/dotnet-documentation) ⭐ 14 | 🐛 0 | 📅 2024-10-27 - SOLID, DI, N-Tier, Logs, etc with dotnet.

## Other Awesome Lists

* [GameDev-Resources](https://github.com/Kavex/GameDev-Resources) ⭐ 6,840 | 🐛 9 | 📅 2026-04-10 - A wonderful list of Game Development resources.
* [Awesome Unity Open Source on GitHub (800+)](https://github.com/baba-s/awesome-unity-open-source-on-github) ⭐ 4,450 | 🐛 12 | 📅 2026-02-02 - A categorized collection of awesome Unity open source on GitHub.
...
* [Awesome Unity Community](https://github.com/UnityCommunity/AwesomeUnityCommunity) ⭐ 653 | 🐛 7 | 📅 2023-03-27 - A categorized community-driven collection of high-quality awesome Unity assets, projects, and resources.
...
You can learn more about how you can contribute to this project in the [contribution guide](https://github.com/proyecto26/.github/blob/master/CONTRIBUTING.md) ⭐ 0 | 🐛 0 | 📅 2026-03-22.
